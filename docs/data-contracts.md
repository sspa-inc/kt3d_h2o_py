...
**Loaded by:** [`load_observation_wells()`](https://github.com/sspa-inc/kt3d_h2o_py/blob/main/data.py)
...
> **Shapefile column name truncation:** Shapefiles truncate column names to 10 characters. [`load_line_features()`](https://github.com/sspa-inc/kt3d_h2o_py/blob/main/data.py) automatically checks both the full name and the first 10 characters when looking up `z_start_col` and `z_end_col`.
...
**Loaded by:** [`load_line_features()`](https://github.com/sspa-inc/kt3d_h2o_py/blob/main/data.py)
...
After loading, all sources are merged and cleaned by [`prepare_data()`](https://github.com/sspa-inc/kt3d_h2o_py/blob/main/data.py).
...
[`remove_duplicate_points()`](https://github.com/sspa-inc/kt3d_h2o_py/blob/main/data.py) is called with `min_dist = config["min_separation_distance"]`.
...
**Written by:** [`export_contours()`](https://github.com/sspa-inc/kt3d_h2o_py/blob/main/main.py)
...
**Written by:** [`export_aux_points()`](https://github.com/sspa-inc/kt3d_h2o_py/blob/main/main.py)
