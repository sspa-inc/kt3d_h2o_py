...
[`build_uk_model()`](https://github.com/sspa-inc/kt3d_h2o_py/blob/main/kriging.py) is called with `drift_matrix=None`. When no
...
|---|---|---|
| [`build_uk_model()`](https://github.com/sspa-inc/kt3d_h2o_py/blob/main/kriging.py) | `kriging.py` | Constructs PyKrige UniversalKriging model |
| [`uk_model.execute()`](https://github.com/sspa-inc/kt3d_h2o_py/blob/main/kriging.py) | PyKrige | Predicts at arbitrary points |
