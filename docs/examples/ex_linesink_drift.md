...
[`compute_linesink_drift_matrix()`](https://github.com/sspa-inc/kt3d_h2o_py/blob/main/AEM_drift.py) is called with
...
[`build_uk_model()`](https://github.com/sspa-inc/kt3d_h2o_py/blob/main/kriging.py) passes the drift columns to PyKrige as
