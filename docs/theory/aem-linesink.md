...
The potential for a single line sink segment is computed in [`compute_linesink_potential()`](https://github.com/sspa-inc/kt3d_h2o_py/blob/main/AEM_drift.py).
...
The implementation in [`compute_linesink_potential()`](https://github.com/sspa-inc/kt3d_h2o_py/blob/main/AEM_drift.py) handles this by perturbing ZZ slightly away from the singular values:
...
This grouping is performed in [`compute_linesink_drift_matrix()`](https://github.com/sspa-inc/kt3d_h2o_py/blob/main/AEM_drift.py):
...
**Training phase** — [`compute_linesink_drift_matrix()`](https://github.com/sspa-inc/kt3d_h2o_py/blob/main/AEM_drift.py) is called without `input_scaling_factors`:
...
[`compute_linesink_drift_matrix()`](https://github.com/sspa-inc/kt3d_h2o_py/blob/main/AEM_drift.py) returns a 3-tuple:
...
The complex potential formula implemented in [`compute_linesink_potential()`](https://github.com/sspa-inc/kt3d_h2o_py/blob/main/AEM_drift.py) follows the line sink element derivation in Strack (1989), adapted for numerical implementation with singularity protection.
